...
itpp::cvec lte_conv_ratematch(const itpp::cmat & d, const uint32 & n_e);
itpp::mat lte_conv_deratematch(const itpp::vec & e_est, const uint32 & n_c);

// LTE convolutional encoding and decoding
itpp::bmat lte_conv_encode(const itpp::bvec & c);
itpp::bvec lte_conv_decode(const itpp::mat & d_est);
