...
int config_bladerf(const bool & sampling_carrier_twist,
				   const double & correction,
				   const int32 & device_index_cmdline,
				   const double & fc,
				   bladerf_device * & dev,
...
#ifdef HAVE_RTLSDR
		if ( config_rtlsdr(initial_sampling_carrier_twist,
						   correction,
						   device_index,
						   fc_requested,
						   rtlsdr_dev,
...
#ifdef HAVE_BLADERF
		if (config_bladerf(initial_sampling_carrier_twist,
						   correction, device_index,
						   fc_requested,
						   bladerf_dev,
						   fs_programmed,
						   gain) == 0 ) {
