...
class bladeRF_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, buflen=4096, dc_offset_i=0, dc_offset_q=0, instance=0, num_buffers=16, num_xfers=8, rx_bandwidth=1.5e6, rx_frequency=435924000, rx_lna_gain=6, rx_sample_rate=4800000, rx_vga_gain=20, serial="", verbosity="info"):
        ...
        self._gui_rx_frequency_range = Range(0, 3.8e9, 1000, rx_frequency, 200)
        ...
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.blocks_add_xx_0, 1))    
...
def argument_parser():
    ...
    parser.add_option(
        "-f", "--rx-frequency", dest="rx_frequency", type="eng_float", default=eng_notation.num_to_str(435924000),
        help="Set Frequency [default=%default]")
    parser.add_option(
        "-l", "--rx-lna-gain", dest="rx_lna_gain", type="intx", default=6,
        help="Set RX LNA Gain [default=%default]")
    parser.add_option(
        "-s", "--rx-sample-rate", dest="rx_sample_rate", type="eng_float", default=eng_notation.num_to_str(4800000),
