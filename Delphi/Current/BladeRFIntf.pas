...
function bladerf_get_sample_rate(device: Pointer;
                                 module: bladerf_module;
                                 var rate: UINT): Integer;  cdecl; external 'bladeRF.dll';

function bladerf_set_bandwidth(device: Pointer;
                               module: bladerf_module;
                               bandwidth: UINT;
                               var actual: UINT): Integer; cdecl; external 'bladeRF.dll';
function bladerf_get_bandwidth(device: Pointer;
                               module: bladerf_module;
                               var bandwidth: UINT): Integer; cdecl; external 'bladeRF.dll';
...
function bladerf_set_rxvga1(device: Pointer;
                            gain: Integer): Integer; cdecl; external 'bladeRF.dll';
function bladerf_get_rxvga1(device: Pointer;
                            var gain: Integer): Integer; cdecl; external 'bladeRF.dll';

function bladerf_set_rxvga2(device: Pointer;
                            gain: Integer): Integer; cdecl; external 'bladeRF.dll';
function bladerf_get_rxvga2(device: Pointer;
                            var gain: Integer): Integer; cdecl; external 'bladeRF.dll';


function bladerf_set_txvga1(device: Pointer;
                            gain: Integer): Integer; cdecl; external 'bladeRF.dll';
function bladerf_get_txvga1(device: Pointer;
                            var gain: Integer): Integer; cdecl; external 'bladeRF.dll';


function bladerf_set_txvga2(device: Pointer;
                            gain: Integer): Integer; cdecl; external 'bladeRF.dll';
function bladerf_get_txvga2(device: Pointer;
                            var gain: Integer): Integer; cdecl; external 'bladeRF.dll';
...
function bladerf_sync_tx(device : Pointer;
                         samples : Pointer;
                         num_samples : UINT;
                         metadata : pbladerf_metadata;
                         timeout_ms : UINT) : Integer;  cdecl; external 'bladeRF.dll';
